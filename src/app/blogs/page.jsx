...
const Blogs = () => {
    ...
    return (
        <div>
         <h1 className=' text-xl font-bold border-b-2 py-4'>Blogs</h1>

         <div>

            {
                blogs.map((blog)=><div key={blog.id} className=' space-y-5 border-2 m-3 p-4'>

                    <h1 className=' text-xl mb-3 font-semibold' >{blog.title}</h1>
